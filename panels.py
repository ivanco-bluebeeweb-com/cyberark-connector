...
async def cyberark_sidebar(ctx, **kwargs) -> ui.UINode:
    ...
    return ui.Stack(direction="v", gap=1, align="stretch", children=[
        ...
        ui.Divider(),
        ui.Button("Safes", variant="ghost", size="sm", full_width=True, align="left", icon="Lock",
                  on_click=ui.Call("__panel__cyberark_safes")),
        ui.Button("Accounts", variant="ghost", size="sm", full_width=True, align="left", icon="KeyRound",
                  on_click=ui.Call("__panel__cyberark_accounts")),
        ui.Button("Access Requests", variant="ghost", size="sm", full_width=True, align="left", icon="ShieldQuestion",
                  on_click=ui.Call("__panel__cyberark_access_requests")),
        ui.Button("Applications", variant="ghost", size="sm", full_width=True, align="left", icon="AppWindow",
                  on_click=ui.Call("__panel__cyberark_applications")),
        ui.Button("Platforms", variant="ghost", size="sm", full_width=True, align="left", icon="LayoutTemplate",
                  on_click=ui.Call("__panel__cyberark_platforms")),
        ui.Button("Security Events", variant="ghost", size="sm", full_width=True, align="left", icon="ScrollText",
